...
class TIGERTrainer(object):
        ...
        for epoch in range(int(np.ceil(self.total_steps / len(train_dataloader)))):
            ...
            if (epoch + 1) % self.epochs_per_eval == 0 and (not self.reverse_bt):
                if self.model is torch.nn.DataParallel:
                    recall_1, recall_5,recall_10,ndcg_5,ndcg_10, eval_loss, dpc, total_hit_count_at_1, total_hit_revenue_sum_at_1, avg_hit_revenue_at_1, total_hit_count_at_10, total_hit_revenue_sum_at_10, avg_hit_revenue_at_10 = evaluate(self.model.module, validation_dataloader, self.device, self.item_len, eval_mode = 'Target', no_output=self.no_output, behavior_token=self.behavior_token)
                else:
                    recall_1, recall_5,recall_10,ndcg_5,ndcg_10, eval_loss, dpc, total_hit_count_at_1, total_hit_revenue_sum_at_1, avg_hit_revenue_at_1, total_hit_count_at_10, total_hit_revenue_sum_at_10, avg_hit_revenue_at_10 = evaluate(self.model, validation_dataloader, self.device, self.item_len, eval_mode = 'Target', no_output=self.no_output, behavior_token=self.behavior_token)
            ...
            if (epoch + 1) % self.epochs_per_all_eval == 0 and self.behavior_token:
                if validation_all_dataloader is not None:
                    if not self.reverse_bt:
                        ...
                        if self.model is torch.nn.DataParallel:
                            recall_1, recall_5,recall_10,ndcg_5,ndcg_10, eval_loss, dpc, total_hit_count_at_1, total_hit_revenue_sum_at_1, avg_hit_revenue_at_1, total_hit_count_at_10, total_hit_revenue_sum_at_10, avg_hit_revenue_at_10 = evaluate(self.model.module, validation_all_dataloader, self.device, self.item_len, no_output=self.no_output, eval_mode = 'Behavior_specific')
                        else:
                            recall_1, recall_5,recall_10,ndcg_5,ndcg_10, eval_loss, dpc,total_hit_count_at_1, total_hit_revenue_sum_at_1, avg_hit_revenue_at_1, total_hit_count_at_10, total_hit_revenue_sum_at_10, avg_hit_revenue_at_10 = evaluate(self.model, validation_all_dataloader, self.device, self.item_len, no_output=self.no_output, eval_mode = 'Behavior_specific')
                        ...
                        self.writer.add_scalar('Metrics/Hit_Count@1_behavior_specific', total_hit_count_at_1, epoch)
                        self.writer.add_scalar('Metrics/Total_Hit_Revenue@1_behavior_specific', total_hit_revenue_sum_at_1, epoch)
                        self.writer.add_scalar('Metrics/Avg_Hit_Revenue@1_behavior_specific', avg_hit_revenue_at_1, epoch)
                        self.writer.add_scalar('Metrics/Hit_Count@10_behavior_specific', total_hit_count_at_10,     epoch)
                        self.writer.add_scalar('Metrics/Total_Hit_Revenue@10_behavior_specific', total_hit_revenue_sum_at_10, epoch)
                        self.writer.add_scalar('Metrics/Avg_Hit_Revenue@10_behavior_specific', avg_hit_revenue_at_10, epoch)              
                        ...
                        perf['Hit_Count@1_behavior_specific'] = total_hit_count_at_1
                        perf['Total_Hit_Revenue@1_behavior_specific'] = total_hit_revenue_sum_at_1
                        perf['Avg_Hit_Revenue@1_behavior_specific'] = avg_hit_revenue_at_1
                        perf['Hit_Count@10_behavior_specific'] = total_hit_count_at_10
                        perf['Total_Hit_Revenue@10_behavior_specific'] = total_hit_revenue_sum_at_10
                        perf['Avg_Hit_Revenue@10_behavior_specific'] = avg_hit_revenue_at_10


                        # Evaluate Behavior-Item prediction
                    if self.model is torch.nn.DataParallel:
                        recall_1, recall_5,recall_10,ndcg_5,ndcg_10, eval_loss, dpc, total_hit_count_at_1, total_hit_revenue_sum_at_1, avg_hit_revenue_at_1, total_hit_count_at_10, total_hit_revenue_sum_at_10, avg_hit_revenue_at_10,acc_bt, recall_bt, precision_bt, tf_bt = evaluate_in_train(self.model.module, validation_all_dataloader, self.device, self.item_len, no_output=self.no_output, eval_mode = 'Behavior_item', reverse_bt = self.reverse_bt)
                    else:
                        recall_1, recall_5,recall_10,ndcg_5,ndcg_10, eval_loss, dpc,total_hit_count_at_1, total_hit_revenue_sum_at_1, avg_hit_revenue_at_1, total_hit_count_at_10, total_hit_revenue_sum_at_10, avg_hit_revenue_at_10, acc_bt, recall_bt, precision_bt, tf_bt = evaluate_in_train(self.model, validation_all_dataloader, self.device, self.item_len, no_output=self.no_output, eval_mode = 'Behavior_item', reverse_bt = self.reverse_bt)
                    ...
                    self.writer.add_scalar('Metrics/Hit_Count@1_all', total_hit_count_at_1, epoch)
                    self.writer.add_scalar('Metrics/Total_Hit_Revenue@1_all', total_hit_revenue_sum_at_1, epoch)
                    self.writer.add_scalar('Metrics/Avg_Hit_Revenue@1_all', avg_hit_revenue_at_1, epoch)
                    self.writer.add_scalar('Metrics/Hit_Count@10_all', total_hit_count_at_10, epoch)
                    self.writer.add_scalar('Metrics/Total_Hit_Revenue@10_all', total_hit_revenue_sum_at_10, epoch)
                    self.writer.add_scalar('Metrics/Avg_Hit_Revenue@10_all', avg_hit_revenue_at_10, epoch)
                    ...
                    perf['Hit_Count@1_all'] = total_hit_count_at_1
                    perf['Total_Hit_Revenue@1_all'] = total_hit_revenue_sum_at_1
                    perf['Avg_Hit_Revenue@1_all'] = avg_hit_revenue_at_1
                    perf['Hit_Count@10_all'] = total_hit_count_at_10
                    perf['Total_Hit_Revenue@10_all'] = total_hit_revenue_sum_at_10
                    perf['Avg_Hit_Revenue@10_all'] = avg_hit_revenue_at_10
                    perf['Accuracy_behavior_only'] = acc_bt
                    perf['Recall_behavior_only'] = recall_bt
                    perf['Precision_behavior_only'] = precision_bt
                    perf['True_positives_behavior_only'] = tf_bt
    ...
    def test(self, test_dataset, test_all_dataset, load_best=True, num_beams = 50):
        ...
        if not self.reverse_bt:
            recall_1, recall_5, recall_10, ndcg_5, ndcg_10, eval_loss, dpc, total_hit_count_at_1, total_hit_revenue_sum_at_1, avg_hit_revenue_at_1, total_hit_count_at_10, total_hit_revenue_sum_at_10, avg_hit_revenue_at_10 = evaluate(self.model, test_dataloader, self.device, self.item_len, eval_mode='Target', no_output=self.no_output, behavior_token=self.behavior_token, num_beams= num_beams)
        ...
        if self.behavior_token:
            ...
            if not self.reverse_bt:
                recall_1, recall_5, recall_10, ndcg_5, ndcg_10, eval_loss, dpc, total_hit_count_at_1, total_hit_revenue_sum_at_1, avg_hit_revenue_at_1, total_hit_count_at_10, total_hit_revenue_sum_at_10, avg_hit_revenue_at_10 = evaluate(self.model, test_all_dataloader, self.device, self.item_len, no_output=self.no_output, eval_mode='Behavior_specific', num_beams= num_beams)
                ...
                results['Hit_Count@1 (Behavior_specific)'] = total_hit_count_at_1
                results['Total_Hit_Revenue@1 (Behavior_specific)'] = total_hit_revenue_sum_at_1
                results['Avg_Hit_Revenue@1 (Behavior_specific)'] = avg_hit_revenue_at_1
                results['Hit_Count@10 (Behavior_specific)'] = total_hit_count_at_10
                results['Total_Hit_Revenue@10 (Behavior_specific)'] = total_hit_revenue_sum_at_10
                results['Avg_Hit_Revenue@10 (Behavior_specific)'] = avg_hit_revenue_at_10
            ...
            recall_1, recall_5, recall_10, ndcg_5, ndcg_10, eval_loss, dpc,total_hit_count_at_1, total_hit_revenue_sum_at_1, avg_hit_revenue_at_1, total_hit_count_at_10, total_hit_revenue_sum_at_10, avg_hit_revenue_at_10, acc_bt, recall_bt, precision_bt, tf_bt = evaluate_in_train(self.model, test_all_dataloader, self.device, self.item_len, no_output=self.no_output, eval_mode='Behavior_item', num_beams= num_beams, reverse_bt = self.reverse_bt)
            ...
            results['Hit_Count@1 (Behavior_item)'] = total_hit_count_at_1
            results['Total_Hit_Revenue@1 (Behavior_item)'] = total_hit_revenue_sum_at_1
            results['Avg_Hit_Revenue@1 (Behavior_item)'] = avg_hit_revenue_at_1
            results['Hit_Count@10 (Behavior_item)'] = total_hit_count_at_10
            results['Total_Hit_Revenue@10 (Behavior_item)'] = total_hit_revenue_sum_at_10
            results['Avg_Hit_Revenue@10 (Behavior_item)'] = avg_hit_revenue_at_10
            results['Accuracy (Behavior_only)'] = acc_bt
            results['Recall (Behavior_only)'] = recall_bt
            results['Precision (Behavior_only)'] = precision_bt
            results['True_positives (Behavior_only)'] = tf_bt
